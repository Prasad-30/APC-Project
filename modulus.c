/*******************************************************************************************************************************************************************
*Title			: Modulus
*Description	: This function performs modulus of two given large numbers and store the result in the resultant list.
             ...
             Dlist **res_head, Dlist **res_tail)
{
    ...
    //store the final remainder i.e value in new_list in the res_list
    copy_list(new_head,new_tail,res_head,res_tail);
